            ...
            <div className='container'>
                <div className='footer-content'>
                    <div className='footer-item'>
                        ...
                        <p style={{ textAlign: 'justify' }}>Smart Loyalty là đơn vị đầu tiên tại Việt Nam có khả năng cung cấp giải pháp toàn diện về Loyalty Marketing, giúp doanh nghiệp tạo
                    ...
                    <div className='footer-item'>
                        ...
                        <p style={{ textAlign: 'justify' }}>CÔNG TY CỔ PHẦN ĐẦU TƯ VÀ PHÁT TRIỂN CÔNG NGHỆ SMART LOYALTY QUỐC TẾ </p>
                        <p style={{ textAlign: 'justify' }}>MST: 0108606357 - Sở KH&ĐT Hà Nội cấp ngày 29/01/2019. </p>
                        <p style={{ textAlign: 'justify' }}>Trụ sở chính: Tầng 6, Tòa nhà Việt Á, số 9 Duy Tân, Phường Dịch Vọng Hậu, Quận Cầu Giấy, Hà Nội.</p>
                    </div>
